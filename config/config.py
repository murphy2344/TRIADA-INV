...
# Groq retired the legacy models for this key. Keep these configurable so a
# provider-side model change does not require another code release.
GROQ_MODEL = os.getenv("GROQ_MODEL", "openai/gpt-oss-120b")
GROQ_FALLBACK_MODEL = os.getenv("GROQ_FALLBACK_MODEL", "openai/gpt-oss-20b")

# Google Gemini. New AI Studio authorization keys are opaque values; do not
# validate them by prefix. Accept the common Render variable names.
GEMINI_API_KEY = (
