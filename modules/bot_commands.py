...
async def setup_bot_commands(bot, admin_id: str):
    ...
    try:
        ...
        user_commands = [
            ...
            BotCommand("fundamentals", "Фундаментальный анализ компании"),
            BotCommand("peers", "Сравнение с конкурентами"),
            BotCommand("analysts", "Мнение аналитиков Wall Street"),
        ...
        admin_commands = [
            ...
            BotCommand("sectors", "Sector Performance (ротация секторов)"),
